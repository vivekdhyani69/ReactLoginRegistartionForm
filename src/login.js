...
const matchedUser = saveData.find(user => user.email === formData.email && user.password === formData.password);
...
<form onSubmit={handleSubmit}>
 ...
 <input type="password" placeholder="Enter passsword" name="password" value={formData.password} onChange={handleChange} /> <br/><br/>
